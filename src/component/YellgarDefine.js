...
const YellgarDefine = props => (
  <div className="y-prcoess-frame">
    ...
    <div className="full-width-content">
      ...
      <h3>我們收集了目前在美國SEO排名前七名的約會網站，註冊成為他們的會員。接著，我們參考並應用Jaime Levy的 Competitive Analysis Matrix 進行競爭者分析，除了研究了各個網站的主要功能、介面設計風格、收費方式以外，我們註冊成為其他網站的會員，瀏覽它們的會員列表，以了解這類型網站的使用者樣貌。</h3>
